(function ($) {
  ...
  $.fn.incremental = function (options) {
    ...
    var btn_reduce =
      '<span class="input-group-btn"><button type="button" class="btn btn-white" data-operator="-">-</button></span>';
    ...
    function calculateCount(count, op) {
      switch (settings.counterMode) {
        case "time":
          ...
          var minutes = operators[op](
            $.fn.incremental.hoursToMinutes(count),
            settings.steps
          );
